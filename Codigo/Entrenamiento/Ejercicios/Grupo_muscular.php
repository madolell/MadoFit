...
<head>
  ...
  <title><?php echo $grupoMuscular ?></title>
</head>
...
<body>
  ...
  <div class="container p-5">
    <div class="row align-items-center ">
      <div class="col-lg-6 col-md-12 mb-md-0 d-flex justify-content-center pb-5 pb-lg-0">
        <?php
      ...
      <div class="col-lg-6 col-md-12 ps-md-5 p-5 text-center text-lg-start rounded azul">
        <?php
        ...
        if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            echo '<div class="col-sm-12 pt-3"><h6><a href="../Ejercicios/Guia/Ejercicios_musculo.php?id_ejercicio=' . $idEjercicio . '" class="ejercicio-link text-light">' . $counter . '. ' . $nombreEjercicio . '</a></h6></div>';
