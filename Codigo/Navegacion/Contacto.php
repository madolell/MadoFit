...
<body class="azul">
  ...
  <!-- Wrapper container -->
  <div class="container p-5 my-5 text-light">
  <div class="row d-flex justify-content-center align-items-center">
    <div class="col col-md-12 col-lg-8">
      <h1 class="mb-3">Contactanos</h1>
      <p>Si tienes alguna pregunta o sugerencia, envíanos un correo electrónico o llámanos al teléfono.</p>
      <p><i class="bi bi-envelope pe-2 mb-0"></i><a href="mailto:44684@a.iesleopoldoqueipo.com" class="text-light">44684@a.iesleopoldoqueipo.com</a></p>
      <p><i class="bi bi-phone pe-2"></i>651795733</p>
      <p><i class="bi bi-geo-alt-fill pe-2"></i>Melilla, 52005</p>
    </div>
