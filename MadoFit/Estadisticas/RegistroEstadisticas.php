...
<head>
    ...
    <title>Registro de estadisticas</title>
</head>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li class="nav-item">
                            <a href="../Estadisticas/RegistroEstadisticas.php" class="nav-link align-middle px-0">
                                <i class="fs-4 bi bi-calendar-event"></i> <span class="ms-1 d-none d-sm-inline">Registrar estadisticas</span>
                            </a>
                        </li>
                        <li>
                            <a href="../Estadisticas/EstablecerObjetivos.php" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi bi-calendar2-check"></i> <span class="ms-1 d-none d-sm-inline">Establecer objetivos</span>
                            </a>
                        </li>
                        <li>
                            <a href="../Estadisticas/HistorialProgreso.php" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi bi-bar-chart-line-fill"></i> <span class="ms-1 d-none d-sm-inline">Historial de progreso</span>
                            </a>
                        </li>
                    </ul>
                    <hr>
            ...
            <div class="col py-5 text-bg-light">
                <div class="container d-flex justify-content-start">
                    <form method="post" action="insertar_datos.php">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" step="0.01" class="form-control" name="masa_muscular" required>
                        </div>
