...
<body>
  ...
  <div class="container p-5">
    <div class="text-start mt-5">
      <h4 class="fs-5">Comienza a entrenar</h4>
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 g-4">
          ...
          <div class="card position-relative shadow-sm border-0">
            <a href="Entrenamiento/Ejercicios.php" class="">
              ...
              <div class="card-body position-absolute bottom-0 start-0 text-light">
                <h6 class="card-title">Entrenamiento Libre</h6>
              </div>
            </a>
          </div>
        </div>
        <div class="col">
          <div class="card position-relative shadow-sm border-0">
            <a href="Entrenamiento/MiEntrenamiento.php" class="">
              <img src="fotos/rutina.jpg" class="card-img-top" alt="Programa de entrenamiento de flexibilidad">
              <div class="card-body position-absolute bottom-0 start-0 text-light">
                <h6 class="card-title">Tus entrenamientos</h6>
              </div>
            </a>
          </div>
        </div>
  ...
  <div class="container p-5 mb-5">
    <h4 class="fs-5">Entrenamientos preestablecidos</h4>
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 g-4 d-flex align-item-center">
      ...
      <div class="col">
        <div class="card position-relative shadow-sm border-0">
          <a href="#"><img src="fotos/entrenamiento6.jpg" class="card-img-top" alt="Programa de entrenamiento para intermedio">
            <div class="card-body position-absolute bottom-0 start-0 text-light">
      ...
      <div class="col">
        <div class="card position-relative shadow-sm border-0">
          <a href="#"><img src="fotos/entrenamiento2.jpg" class="card-img-top" alt="Programa de entrenamiento de fuerza">
            <div class="card-body position-absolute bottom-0 start-0 text-light">
              <h6 class="card-title">Programa de entrenamiento de fuerza</h6>
            </div>
          </a>
        </div>
      </div>
      <div class="col">
        <div class="card position-relative shadow-sm border-0">
          <a href="#"><img src="fotos/entrenamiento3.jpg" class="card-img-top" alt="Programa de entrenamiento para pérdida de peso">
            <div class="card-body position-absolute bottom-0 start-0 text-light">
              <h6 class="card-title">Programa de entrenamiento para pérdida de peso</h6>
            </div>
          </a>
        </div>
      </div>
      <div class="col">
        <div class="card position-relative shadow-sm border-0">
          <a href="#"><img src="fotos/entrenamiento4.jpg" class="card-img-top" alt="Programa de entrenamiento de resistencia">
            <div class="card-body position-absolute bottom-0 start-0 text-light">
              <h6 class="card-title">Programa de entrenamiento de resistencia</h6>
            </div>
          </a>
        </div>
      </div>
      <div class="col">
        <div class="card position-relative shadow-sm border-0">
          <a href="#"><img src="fotos/entrenamiento5.jpg" class="card-img-top" alt="Programa de entrenamiento de flexibilidad">
            <div class="card-body position-absolute bottom-0 start-0 text-light">
              <h6 class="card-title">Programa de entrenamiento de flexibilidad</h6>
            </div>
          </a>
        </div>
      </div>
