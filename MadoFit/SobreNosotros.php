...
<body>
  ...
  <section id="sobre-nosotros" class="bg-light py-5 m-5">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h2>Sobre Nosotros</h2>
          <p class="lead">En MadoFit nos dedicamos a ayudar a las personas a mejorar su salud y bienestar a través de la
            práctica de ejercicios físicos.</p>
          <p>Desde nuestra fundación en 2023, hemos estado comprometidos con nuestro objetivo de brindar a nuestros
            clientes un ambiente acogedor y motivador, donde puedan alcanzar sus metas y mejorar su calidad de vida.</p>
          <p>Nuestro equipo de entrenadores altamente capacitados está aquí para guiarlo y apoyarlo en cada paso del
            camino, ofreciéndole planes de entrenamiento personalizados para que pueda alcanzar su máximo potencial.</p>
        </div>
        <div class="col-md-6 d-flex justify-content-center">
          <img src="fotos/logoblancoynegro-removebg-preview.png" alt="Gimnasio MadoFit" class="img-fluid rounded">
        </div>
      </div>
    </div>
  </section>
