...
<body>
  ...
  <!-- Nav del logo -->
    ...
    <div class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active c-item">
                <img src="fotos/FitnessNa.jpg" class="d-block w-100 c-img" alt="...">
            </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            <h1 class="mb-3">Enviar una solicitud</h1>
            <form action="Auxiliares/enviar_solicitud.php" method="POST">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label for="your-email" class="form-label">Correo electrónico</label>
                        <input type="email" class="form-control" id="your-email" name="your-email" required>
                    </div>
                    <div class="col-md-6">
                        <label for="your-subject" class="form-label">Asunto</label>
                        <input type="text" class="form-control" id="your-subject" name="your-subject">
                    </div>
                    <div class="col-12">
                        <label for="your-message" class="form-label">Mensaje</label>
