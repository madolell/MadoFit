...
<body>
  ...
  <div class="container-fluid">
    <div class="text-center rounded text-bg-dark py-4 m-5">
      <h1 class="display-6">Ejercicios MadoFit</h1>
    ...
    <div class="row gx-4 d-flex justify-content-center align-content-center text-center px-5 pt-5">
      <div class="col-7 col-md-4 shadow p-3 mb-5 bg-body rounded-5">
        <a href="#"><img src="fotos/inicio.jpg" class="img-fluid" alt=""></a>
        <h5 class="lead">Ejercicios personalizados</h5>
        <p class="text-muted">Define tu objetivo y selecciona el programa perfecto para lograrlo.
        </p>
      </div>
      <div class="col-7 col-md-4 shadow p-3 mb-5 bg-body rounded-5 pos">
        <a href="#"><img src="fotos/inicio1.jpg" class="img-fluid" alt=""></a>
        <h5 class="lead">Controla tu entrenamiento</h5>
      ...
      <div class="col-7 col-md-4 shadow p-3 mb-5 bg-body rounded-5">
        <a href="#"><img src="fotos/inicio2.jpg" class="img-fluid" alt=""></a>
        <h5 class="lead">La rutina perfecta</h5>
        <p class="text-muted">Tienes todo para lograr tus objetivos en casa; el calentamiento, la música, los
          movimientos y esta web.
        </p>
      </div>
    </div>
