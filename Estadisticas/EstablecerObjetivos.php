...
<head>
    ...
    <title>Establecer Objetivos</title>
</head>
            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        id="menu">
                        <li class="nav-item">
                            <a href="../Estadisticas/RegistroEstadisticas.html" class="nav-link align-middle px-0">
                                <i class="fs-4 bi bi-calendar-event"></i> <span
                                    class="ms-1 d-none d-sm-inline">Registrar estadisticas</span>
                            </a>
                        </li>
                        <li>
                            <a href="../Estadisticas/EstablecerObjetivos.html" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi bi-calendar2-check"></i> <span
                                    class="ms-1 d-none d-sm-inline">Establecer objetivos</span>
                            </a>
                        </li>
                        <li>
                            <a href="../Estadisticas/HistorialProgreso.html" class="nav-link px-0 align-middle">
