...
<head>
    ...
    <title>Programa de entrenamiento para principiantes</title>
</head>
...
<body>
    ...
    <tbody>
        ...
        $programaEntrenamiento = array(
            ...
            array('Descanso', '', ''),
            array('Entrenamiento de cuerpo completo', 'Zancadas, Fondos de tríceps, Press de hombros con mancuernas, Abdominales', '3x10, 3x10, 3x10, 3x15'),
            array('Descanso', '', ''),
            array('Entrenamiento de cuerpo completo', 'Levantamiento de talones, Remo con mancuerna, Flexiones de brazos inclinadas, Plancha lateral', '3x15, 3x10, 3x10, 3x30s'),
            array('Descanso', '', ''),
            array('Descanso', '', '')
        );
